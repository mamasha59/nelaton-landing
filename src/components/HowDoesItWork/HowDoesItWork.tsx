...
export default function HowDoesItWork({ref}:HowDoesItWorkProps) {
  ...
  <section ref={ref} className="lg:my-[132px] my-12">
    <h5 className="text-black font-semibold lg:text-[64px] lg:leading-[72px] text-[32px] leading-[40px] text-center lg:mb-8 mb-6 tracking-tighter">
      How does it <span className="text-blue">work?</span>
    </h5>
