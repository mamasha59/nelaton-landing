...
export default function GetStarted() {
  return (
    <div className="centred-view">
        <div className="lg:p-[72px] w-full relative p-5 rounded-2xl flex flex-row bg-white shadow-md z-30 flex-wrap lg:-my-32 -my-10 lg:mb-40 mb-5">
            ...
            <div className="lg:-mb-52 mb-6 z-10 lg:order-2 order-1 flex flex-1 justify-center items-center ml-5">
                <Image
