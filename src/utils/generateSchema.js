async function generateSchema() {
    ...
    "therapy": {
        "@type": "MedicalTherapy",
        "name": "Intermittent Self-Catheterisation (ISC)",
        "alternateName": "ISC",
        "description": "A method of regularly emptying the bladder using a catheter. It is used for neurogenic bladder, multiple sclerosis, and other urinary disorders.",
