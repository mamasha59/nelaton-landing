...
export default function Page() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      ...
      const faqBlockPosition =
        faqBlock.current.getBoundingClientRect().top + window.scrollY;
      ...
      if (
        ...
        scrollPosition + headerHeight <= faqBlockPosition
      ) {
  ...
  return (
    <>
      <Header
        isInView={isInView}
        refFeaturesBlock={featuresBlock}
        faqBlockRef={faqBlock}
      />
      <main>
